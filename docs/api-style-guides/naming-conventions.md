...
This topic describes the naming conventions used in Bosonical APIs. In
general, these conventions apply to all Bosonical-managed services.
...
-   Avoid overly general names that are ambiguous within the context of
    the API and the larger ecosystem of Bosonical APIs. They can lead to
