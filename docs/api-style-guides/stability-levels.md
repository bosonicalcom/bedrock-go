...
While different organizations (both inside Bosonical and outside) have different
...
gravity as creating a new major version. For example, at Bosonical, this requires
