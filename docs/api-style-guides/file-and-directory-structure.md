...
such as those used throughout Bosonical. While the spirit of this guidance applies
...
Bosonical APIs **must** reside in a directory that matches the protocol buffer
